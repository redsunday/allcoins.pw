...
echo	    WebDriverWait(driver, 120).until(EC.visibility_of_all_elements_located((By.XPATH,'//*[contains(text(),"40 MB")]'))) >> autobricks.py
...
echo	    driver.find_element_by_id("mkto_form_consent").send_keys(Keys.END)	>> autobricks.py
...
echo		#input command >> autobricks.py
...
taskkill /F /FI "WINDOWTITLE eq Try Databricks*"
goto :loop		
